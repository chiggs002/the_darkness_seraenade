...
//
//   SENDS ALL OUTPUTS TO THE MAXMSP AND GRAPHICS PROCESSING ON PORTS 6000 AND 6001
//
//   CALCULATES THE FOLLOWING  DATA TO SEND ON TO MAXMSP AND PROCESSING:
//
//
...
//
//
//   Sends out osc data on port 6000 to processing and 6001 to max on the local network
//   NetAddress("127.0.0.1",6000);
//
//   header: /kinnect/inputs
//
...
//
//    IT THEN SENDS ALL THIS DATA TO the maxmsp patch and the kinect graphics pacth
//
