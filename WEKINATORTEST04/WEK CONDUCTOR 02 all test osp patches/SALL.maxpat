...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 95.0, 288.0, 368.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 350.0, 161.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "S02_ACCEL"
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/WEKINATORTEST04/WEK CONDUCTOR 02 all test osp patches",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
