...
void oscEvent(OscMessage theOscMessage) {
 ...
 if (theOscMessage.checkAddrPattern("/wek/outputs")==true) {
     if(theOscMessage.checkTypetag("fffffffffffffffff")) { // looking for 4 control value
        ...
        oscGraphicsTrigger=map(theOscMessage.get(12).floatValue(),0.0241,25,5,12);
        oscColourTrigger=map(theOscMessage.get(13).floatValue(),1.2166,50,8,12);
...
// NetAddress dest,dest_Max2,dest_Max3,dest_Max4,dest_Max5;
 oscP5.send(msg, dest);
